    ...
    return {
        ...
        "ScreenRegister": {
            "requests": [
                {
                    "method": "GET",
                    "url": f"{inputs.get('URL_BASE')}/Processo/cadastrar.seam?newInstance=true",
                    "update_form": True,
                    "payload": {},
                    "headers": {},
                }]},
            ...
            "requests": [
                ...
                },
                {
                    ...
                    "payload": {
                        ...
                        'processoTrfForm:classeJudicial:classeJudicialComboDecoration:classeJudicialCombo': inputs.get('classe'),
                        'processoTrfForm': 'processoTrfForm',
                        "formProcessoTrf:classeJudicial:processoReferenciaInputDecoration:processoReferenciaInput": "",
                        'autoScroll': '',
                        'javax.faces.ViewState': inputs.get('ViewState'),
